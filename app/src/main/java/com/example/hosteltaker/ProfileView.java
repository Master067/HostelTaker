...
public class ProfileView extends AppCompatActivity {
    ...
    TextView textViewName,textViewEmail,textViewPhone,textViewHostelName,textViewAddress;
    ImageView edit_name,edit_email,edit_address,edit_hosteName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewHostelName = findViewById(R.id.display_hostel);
        textViewEmail = findViewById(R.id.display_email);
        textViewAddress = findViewById(R.id.display_address);
        textViewPhone = findViewById(R.id.display_phone);
        edit_name = findViewById(R.id.edit_name_button);
        edit_email = findViewById(R.id.edit_email_button);
        edit_hosteName = findViewById(R.id.edit_hostel_button);
        edit_address = findViewById(R.id.edit_address_button);
        ...
        if (user_id.equals(fuser.getUid())) {
            ...
            edit_hosteName.setVisibility(View.VISIBLE);
        }
